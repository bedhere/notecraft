...
object Strings {
    ...
    const val formatItalic = "斜体"
    const val formatHeading = "一级标题"
    const val formatThematicBreak = "分割线"
    const val formatBulletList = "无序列表"
    const val formatOrderedList = "有序列表"
    const val formatCodeBlock = "代码块"
    const val formatBlockquote = "引用"
    ...
    const val close = "关闭"
    const val minimize = "最小化"
    const val maximize = "最大化"
